export default {
  pages: [
    ...
    },
    {
      ...
      text: 'The first time you set up a classroom, click the "Register" button and provide information about yourself. You only have to do this once. Then, click the "New" button to create a new classroom and invite your students by sending them a link. From here, you can monitor how many classifications your students make on WildCam and you can create assignments.',
    },
    {
      title: 'Create an assignment',
      image: require('../../../images/tutorial/educator-tutorial-3.gif'),
      text: 'An assignment allows you to select a set of WildCam images for your students to identify themselves. Then, students can download their own data as well as public identifications for that same set of images. Within a classroom, click the assignments tab and click the "New assignment" button. Select the number of images you want each student to identify, and select which students in your class will receive this assignment. Next, select the set of images your students will identify by filtering the map and clicking "Select for Assignment."',
    },
    {
    ...
    },
    {
      ...
      text: 'The Resource page contains links to classroom-ready activities developed by HHMI BioInteractive. The "WildCam Lab Activities" section includes activities that guide you through using the WildCam Lab to teach inquiry-based ecology concepts. The "Related Resources" section includes resources that provide students with background information about Gorongosa ecology.',
    },
  ]
}
